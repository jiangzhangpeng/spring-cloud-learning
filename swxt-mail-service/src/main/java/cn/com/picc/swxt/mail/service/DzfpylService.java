...
public class DzfpylService {
	...
	public void sendSimpleMail() {
		logger.debug("come into DzfpylService.sendSimpleMail");
		logger.debug("start to check the switch ");
		List<SysCommonPropertyBean> proList = sysCommonPropertyDao.getPropertyByProName(Constants.SwitchType.DZFPYL);
		...
		sysCommonPropertyDao.updateSwitch(Constants.SwitchType.DZFPYL, Constants.SwitchStatus.CLOSED);
		logger.debug("leave DzfpylService.sendSimpleMail");
	}
