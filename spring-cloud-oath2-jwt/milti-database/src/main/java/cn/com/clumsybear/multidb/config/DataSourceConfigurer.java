package cn.com.clumsybear.multidb.config;
...
import cn.com.clumsybear.multidb.common.DataSourceKey;
...
public class DataSourceConfigurer {
	 ...
	 * master DataSource
	 * 
	 * @Primary 注解用于标识默认使用的 DataSource Bean，因为有5个 DataSource Bean，该注解可用于 master 或
